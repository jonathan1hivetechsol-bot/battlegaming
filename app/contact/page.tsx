        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-16">
            ...
            <div className="bg-[#1a1a3e]/60 p-8 rounded-lg border border-[#FF7828]/30 hover:border-[#FF7828] transition-all duration-300 text-center">
              ...
              <p className="text-gray-300 text-sm mb-4">support@battlegaming.store</p>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-[#1a1a3e]/60 p-8 rounded-lg border border-[#FF7828]/30 hover:border-[#FF7828]/60 transition-all duration-300">
                ...
                <p className="text-gray-300 leading-relaxed">Multiple options: Live chat (instant), Email (support@battlegaming.store), WhatsApp (+1-780-851-1699), or this contact form. We respond within 2 hours guaranteed or your money back.</p>
              </div>
            </div>
          </div>
