...
export default function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to profile page on successful signin
      router.push('/profile');
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0d071a] to-[#1a0f2e] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-[#FF7828] mb-2">Sign In</h2>
          <p className="text-gray-400">Access your BattleGaming account</p>
        </div>
        ...
        <div className="bg-[#1a0f2e] border border-[#FF7828]/20 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400">
              ...
              <Link href="/signup" className="text-[#FF7828] hover:text-[#ff6b00] font-semibold">
                Create Account
              </Link>
            </p>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-700/50 space-y-2">
            <div className="flex items-center text-sm text-gray-400">
              ...
              <span>Secure login with BattleGaming encryption</span>
            </div>
            <div className="flex items-center text-sm text-gray-400">
              <span className="text-[#45f882] mr-2">✓</span>
              <span>Access your verified account purchases</span>
            </div>
            <div className="flex items-center text-sm text-gray-400">
              <span className="text-[#45f882] mr-2">✓</span>
